...
{
    JFrame frame;
    private ResourceBundle resBundle = ResourceBundle.getBundle("Projekt/label", new Locale("en"));
    JButton stopButton,savButton,resetButton,startButton,exitButton,nButton,showPanel,hidePanel;
    TitledBorder tit,pit,git;
    JPanel panel,buttonPanel,menuPanel,statistics,panelDisName,data,data2;
        ...
        EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                try
                {
                    ...
                    window.frame.setSize(1440,960);
                    //window.frame.setExtendedState(JFrame.MAXIMIZED_BOTH); opcjonalnie na później - FULLSCREEN
    ...
    private void initialize()
    {
        ...
        nButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e)
            {
                URL resource = getClass().getResource("kor2map.png");
                try
                {
               ...
               Dimension dimension = new Dimension(image.getWidth(panel), image.getHeight(panel));
            }
        }
        );
        ...
        lang4.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                changeLangName();
                if(z.equals("Cholera") || z.equals("Xолера"))
                {
                    changeNameofDisease(resBundle.getString("menuIt.disChol"));
                    info.setActionCommand(resBundle.getString("menuIt.selectChol"));
                }
        ...
        panelDisName.setBounds(35, 24, 380, 40);
        ...
        weeks = new JLabel(resBundle.getString("lab.week"));				//licznik trwania choroby, w budowie w przyszłosci :)
    ...
    {
        if(s.equals("Ognisko epidemii") || s.equals("Центр эпидемии") || s.equals("Outbreak")||s.equals("Ausbruch"))
        {
